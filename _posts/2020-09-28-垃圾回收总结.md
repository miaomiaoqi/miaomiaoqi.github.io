...
![http://www.miaomiaoqi.github.io/images/jvm/gc/gc_1.png](http://www.miaomiaoqi.github.io/images/jvm/gc/gc_1.png)
...
-   程序计数器: 线程独有的, 可以把它看作是当前线程执行的字节码的行号指示器, 比如如下字节码内容, 在每个字节码`前面都有一个数字(行号), 我们可以认为它就是程序计数器存储的内容
    ...
    ![http://www.miaomiaoqi.github.io/images/jvm/gc/gc_2.png](http://www.miaomiaoqi.github.io/images/jvm/gc/gc_2.png)
...
![http://www.miaomiaoqi.github.io/images/jvm/gc/gc_3.png](http://www.miaomiaoqi.github.io/images/jvm/gc/gc_3.png)
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_4.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_4.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_5.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_5.png" style="zoom: 67%;" />
...
![http://www.miaomiaoqi.github.io/images/jvm/gc/gc_6.png](http://www.miaomiaoqi.github.io/images/jvm/gc/gc_6.png)
...
2.  对可回收的对象进行回收
    ...
    ![http://www.miaomiaoqi.github.io/images/jvm/gc/gc_7.png](http://www.miaomiaoqi.github.io/images/jvm/gc/gc_7.png)
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_8.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_8.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_9.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_9.png" style="zoom:67%;" />
...
![http://www.miaomiaoqi.github.io/images/jvm/gc/gc_10.png](http://www.miaomiaoqi.github.io/images/jvm/gc/gc_10.png)
...
![http://www.miaomiaoqi.github.io/images/jvm/gc/gc_11.png](http://www.miaomiaoqi.github.io/images/jvm/gc/gc_11.png)
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_12.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_12.png" style="zoom:67%;" />

当 Eden 区将满时, 触发 Minor GC

<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_13.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_13.png" style="zoom:67%;" />
...
![http://www.miaomiaoqi.github.io/images/jvm/gc/gc_14.gif](http://www.miaomiaoqi.github.io/images/jvm/gc/gc_14.gif)
...
![http://www.miaomiaoqi.github.io/images/jvm/gc/gc_15.gif](http://www.miaomiaoqi.github.io/images/jvm/gc/gc_15.gif)
...
*   当对象的年龄达到了我们设定的阈值, 则会从S0(或S1)晋升到老年代
    ...
    ![http://www.miaomiaoqi.github.io/images/jvm/gc/gc_16.gif](http://www.miaomiaoqi.github.io/images/jvm/gc/gc_16.gif)
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_17.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_17.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_18.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_18.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_19.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_19.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_20.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_20.png" style="zoom:67%;" />

#### Parallel Old 收集器

Parallel Old 是相对于 Parallel Scavenge 收集器的老年代版本, 使用多线程和标记整理法, 两者组合示意图如下,这两者的组合由于都是多线程收集器, 真正实现了「吞吐量优先」的目标

<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_21.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_21.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_22.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_22.png" style="zoom:67%;" />
...
![http://www.miaomiaoqi.github.io/images/jvm/gc/gc_23.png](http://www.miaomiaoqi.github.io/images/jvm/gc/gc_23.png)

而 G1 各代的存储地址不是连续的, 每一代都使用了 n 个不连续的大小相同的 Region, 每个Region占有一块连续的虚拟内存地址, 如图示

<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_24.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_24.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_25.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_25.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_26.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_26.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_27.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_27.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_28.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_28.png" style="zoom:67%;" />

<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_29.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_29.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_30.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_30.png" style="zoom:67%;" />

再次修改配置, 去除元空间限制, 修改堆内存大小 -Xms20m -Xmx20m, 可以看见堆内存报错. 

<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_31.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_31.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_32.png" alt="http://www.miaomiaoqi.github.io/images/jvm/gc/gc_32.png" style="zoom:67%;" />
