...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_22.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_22.png)

上图中包含了库存和订单两个独立的微服务，每个微服务维护了自己的数据库。在交易系统的业务逻辑中，一个商品在下单之前需要先调用库存服务，进行扣除库存，再调用订单服务，创建订单记录。

正常情况下，两个数据库各自更新成功，两边数据维持着一致性。

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_23.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_23.png)

但是，在非正常情况下，有可能库存的扣减完成了，随后的订单记录却因为某些原因插入失败。这个时候，两边数据就失去了应有的一致性。

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_24.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_24.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_25.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_25.png)

当队员收到就位确认提示后，如果已经就位，就选择“是”，如果还没就位，就选择“否”。

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_26.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_26.png)

当队长收到了所有人的就位确认，就会向所有队员们发布消息，告诉他们开始打BOSS。

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_27.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_27.png)

相应的，在队长发起就位确认的时候，有可能某些队员还并没有就位：

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_28.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_28.png)

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_29.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_29.png)

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_30.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_30.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_31.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_31.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_32.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_32.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_33.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_33.png)

**第二阶段：**

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_34.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_34.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_1.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_1.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_2.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_2.png)

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_3.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_3.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_4.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_4.png)

多服务

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_5.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_5.png)

SOA

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_6.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_6.png)

微服务架构

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_7.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_7.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_8.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_8.png)

## 不使用JTA实现分布式事务

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_9.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_9.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_10.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_10.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_13.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_13.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_11.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_11.png)

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_12.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_12.png)

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_14.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_14.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_15.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_15.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_16.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_16.png)

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_17.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_17.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_18.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_18.png)

![http://miaomiaoqi.github.io/images/distributed/transaction/tran_19.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_19.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_20.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_20.png)
...
![http://miaomiaoqi.github.io/images/distributed/transaction/tran_21.png](http://miaomiaoqi.github.io/images/distributed/transaction/tran_21.png)
