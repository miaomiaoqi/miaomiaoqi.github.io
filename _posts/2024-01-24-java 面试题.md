...
![https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_2.png](https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_2.png)



![https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_4.png](https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_4.png)



Node 节点的属性值

![https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_3.png](https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_3.png)
...
![https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_5.png](https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_5.png)

公平锁与非公平锁的 lock() 方法唯一的区别就在于公平锁在获取同步状态时多了一个限制条件: hasQueuedPredecessors(), hasQueuedPredecessors 是公平锁加锁时判断等待队列中是否存在有效节点的方法

![https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_6.png](https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_6.png)

模拟银行 3 个客户来办理业务, A 先抢到锁, 然后 B, C 进行排队

![https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_7.png](https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_7.png)

![https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_8.png](https://miaomiaoqi.github.io/images/java/concurrency/aqs/aqs_8.png)
...
第三级缓存: Map<String, ObjectFactory<?>> singletomFactories, 存放可以生成 bean 的工厂
