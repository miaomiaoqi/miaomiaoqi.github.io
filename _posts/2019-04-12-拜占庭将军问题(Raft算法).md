...
![https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_1.png](https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_1.png)

**第二步**，成为Candidate的节点，会首先给自己投票，然后向集群中其他所有的节点发起请求，要求大家都给自己投票

![https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_2.png](https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_2.png)

**第三步**，其他收到投票请求且还未投票的Follower节点会向发起者投票，发起者收到反馈通知后，票数增加。

![https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_3.png](https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_3.png)

**第四步**，当得票数超过了集群节点数量的一半，该节点晋升为Leader节点。Leader节点会立刻向其他节点发出通知，告诉大家自己才是老大。收到通知的节点全部变为Follower，并且各自的计时器清零。

![https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_4.png](https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_4.png)
...
![https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_5.png](https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_5.png)

一旦Leader节点挂掉，发不出通知，那么计时达到了超时时间的Follower节点会转变为Candidate节点，发起选主投票，周而复始......

![https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_6.png](https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_6.png)
...
![https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_7.png](https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_7.png)

**第二步**，由Leader节点把数据复制到集群内所有的Follower节点。如果一次复制失败，会不断进行重试。

![https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_8.png](https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_8.png)

**第三步**，Follower节点们接收到复制的数据，会反馈给Leader节点。

![https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_9.png](https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_9.png)

**第四步**，如果Leader节点接收到超过半数的Follower反馈，表明复制成功。于是提交自己的数据，并通知客户端数据提交成功。

![https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_10.png](https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_10.png)

**第五步**，由Leader节点通知集群内所有的Follower节点提交数据，从而完成数据同步流程。

![https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_11.png](https://www.miaomiaoqi.github.io/images/algorithm/raft/raft_11.png)
