...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_1.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_1.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_2.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_2.png)

但是也可以分为四层, 就是**把链路层和物理层都表示为网络接口层**

![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_3.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_3.png)

还有一种就是 OSI 七层网络模型, 它就是在五层协议之上加了**表示层和会话层**

![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_4.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_4.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_5.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_5.png)
...
-   HTTP 是未经安全加密的协议, 它的传输过程容易被攻击者监听、数据容易被窃取、发送方和接收方容易被伪造；而 HTTPS 是安全的协议, 它通过 **密钥交换算法 - 签名算法 - 对称加密算法 - 摘要算法** 能够解决上面这些问题. 
    ...
    ![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_6.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_6.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_7.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_7.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_8.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_8.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_9.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_9.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_10.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_10.png)

下面为你罗列了一些 TCP 和 UDP 的不同点, 方便理解, 方便记忆. 

![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_11.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_11.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_12.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_12.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_13.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_13.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_14.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_14.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_15.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_15.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_16.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_16.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_17.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_17.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_18.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_18.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_19.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_19.png)
...
-   首先, 你需要在浏览器中的 URL 地址上, 输入你想访问的地址, 如下
    ...
    ![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_20.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_20.png)
...
-   然后, 浏览器会根据你输入的 URL 地址, 去查找域名是否被本地 DNS 缓存, 不同浏览器对 DNS 的设置不同, 如果浏览器缓存了你想访问的 URL 地址, 那就直接返回 ip. 如果没有缓存你的 URL 地址, 浏览器就会发起系统调用来查询本机 `hosts` 文件是否有配置 ip 地址, 如果找到, 直接返回. 如果找不到, 就向网络中发起一个 DNS 查询. 
    ...
    ![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_21.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_21.png)

    DNS 是一种分层数据库, 它的主要层次结构如下

    ![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_22.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_22.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_23.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_23.png)
...
![https://www.miaomiaoqi.github.io/images/net/httpinterview/http_24.png](https://www.miaomiaoqi.github.io/images/net/httpinterview/http_24.png)
