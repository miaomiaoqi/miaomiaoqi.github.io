...
* 接下来引出一个新的问题, 如果我们已知0到9级台阶走法有X种, 0到8级台阶有Y中走法, 那么0到10级台阶的走法有多少种?
	...
	![http://www.milky.show/images/algorithm/dynamic_1.png](http://www.milky.show/images/algorithm/dynamic_1.png)
	...
	* 方法一: 递归求解
		...
		![http://www.milky.show/images/algorithm/dynamic/dynamic_2.png](http://www.milky.show/images/algorithm/dynamic/dynamic_2.png)
		...
		![http://www.milky.show/images/algorithm/dynamic/dynamic_3.png](http://www.milky.show/images/algorithm/dynamic/dynamic_3.png)
	...
	* 方法三: 动态规划求解
		...
		![http://www.milky.show/images/algorithm/dynamic/dynamic_4.png](http://www.milky.show/images/algorithm/dynamic/dynamic_4.png)

		表格的第一行代表了楼梯台阶的数量, 第二行代表了若干级台阶对应的走法数. F(1) = 1, F(2) = 2, 这是之前已经明确过的

		![http://www.milky.show/images/algorithm/dynamic/dynamic_5.png](http://www.milky.show/images/algorithm/dynamic/dynamic_5.png)

		第一次迭代, 台阶数等于3时, 走法数量是3, 这个结果是F(1), F(2)这两个结果相加得来的, 所以F(3)只依赖F(1)和F(2)

		![http://www.milky.show/images/algorithm/dynamic/dynamic_6.png](http://www.milky.show/images/algorithm/dynamic/dynamic_6.png)

		第二次迭代, 台阶数等于4时, 走法数量是5, 这个结果是F(2), F(3)这两个结果相加得来的, 所以F(4)只依赖F(2)和F(3)

		![http://www.milky.show/images/algorithm/dynamic/dynamic_7.png](http://www.milky.show/images/algorithm/dynamic/dynamic_7.png)
...
* 有一个国家发现了5座金矿, 每座金矿的黄金储量不同, 需要参与挖掘的工人数也不同。参与挖矿工人的总数是10人。每座金矿要么全挖, 要么不挖, 不能派出一半人挖取一半金矿。要求用程序求解出, 要想得到尽可能多的黄金, 应该选择挖取哪几座金矿？
  ...
  ![http://www.milky.show/images/algorithm/dynamic/dynamic_8.png](http://www.milky.show/images/algorithm/dynamic/dynamic_8.png)
...
* 动态规划有三个核心元素: **最优子结构, 边界, 状态转移量**, 首先思考一下这个题目的最优子结构, 题目要求10个工人5个金矿时, 挖最多黄金的选择. **那么最优子结构应该是10个工人4个金矿时, 挖出最多金矿的选择**
  ...
  * 如果选择挖, 会占用掉一部分工人, 那么前4个金矿所分配的工人数量就是[10 - 第5个金矿所需人数], 而不再是10 了, 所以说问题的最优子结构有两个, 一个是4金矿10工人时的最优选择, 一个是4金矿10 - 3工人时的最优选择
  ...
  ![http://www.milky.show/images/algorithm/dynamic/dynamic_9.png](http://www.milky.show/images/algorithm/dynamic/dynamic_9.png)

* 接下来讨论4个金矿的最优选择和5个金矿的最优选择之间是什么样的关系呢?

  **5个金矿的最优选择, 就是(前4座金矿10工人的挖金数量)和(前4做金矿7工人挖金数量 + 第5座金矿的挖金数量)的最大值**

  ![http://www.milky.show/images/algorithm/dynamic/dynamic_10.png](http://www.milky.show/images/algorithm/dynamic/dynamic_10.png)
...
* **方法四: 动态规划**
  ...
  ![http://www.milky.show/images/algorithm/dynamic/dynamic_11.png](http://www.milky.show/images/algorithm/dynamic/dynamic_11.png)
  ...
  **第1座金矿的信息, 400金, 5工人**, 所以前4格都是0, 因为工人不够, 后面的格子都是400, 因为只有这一座金矿可挖
  ...
  ![http://www.milky.show/images/algorithm/dynamic/dynamic_12.png](http://www.milky.show/images/algorithm/dynamic/dynamic_12.png)

  第一行实际上就是我们刚才分析的问题边界, 从第二行开始就会复杂了

  **第2座金矿有500黄金, 需要5工人**, 第2行的前4个格子怎么算呢? 因为W < 5, 所以F(N, W) = F(N - 1, W) = 0

  ![http://www.milky.show/images/algorithm/dynamic/dynamic_13.png](http://www.milky.show/images/algorithm/dynamic/dynamic_13.png)

  第2行的后6个格子怎么算呢? 因为 W >= 5, 所以根据F(N, W) = Max(F(N-1 , W), F(N - 1, W - 5) + 500), 第5-9个格子的值是500

  ![http://www.milky.show/images/algorithm/dynamic/dynamic_14.png](http://www.milky.show/images/algorithm/dynamic/dynamic_14.png)

  需要注意的是第2行的第10个格子, 也就是N = 2, W = 10的时候, F(N - 1, W) = 400, F(N - 1, W - 5) = 400, Max(400, 400 + 500) = 900

  ![http://www.milky.show/images/algorithm/dynamic/dynamic_15.png](http://www.milky.show/images/algorithm/dynamic/dynamic_15.png)

  **第3座金矿有200黄金, 需要3工人**, 第3行的计算方法如出一辙

  ![http://www.milky.show/images/algorithm/dynamic/dynamic_16.png](http://www.milky.show/images/algorithm/dynamic/dynamic_16.png)

  第4座金矿有300黄金, 需要4工人

  第5座金矿有350黄金, 需要3工人

  ![http://www.milky.show/images/algorithm/dynamic/dynamic_17.png](http://www.milky.show/images/algorithm/dynamic/dynamic_17.png)

  **似乎除了第1行以外, 每个格子都是前一行的一个或两个格子推导而来**, 比如3金矿的8工人的结果, 就来自于2金矿5工人和2金矿8工人, Max(500, 500 + 200) = 700

  ![http://www.milky.show/images/algorithm/dynamic/dynamic_18.png](http://www.milky.show/images/algorithm/dynamic/dynamic_18.png)

  再比如5金矿10工人的结果, 就来自于4金矿7工人和4金矿10工人, Max(900, 500 + 350) = 900

  ![http://www.milky.show/images/algorithm/dynamic/dynamic_19.png](http://www.milky.show/images/algorithm/dynamic/dynamic_19.png)
...
* **方法二：平方根法**
	...
	![http://www.milky.show/images/algorithm/dynamic/dynamic_20.png](http://www.milky.show/images/algorithm/dynamic/dynamic_20.png)
...
* **方法三: 解方程法**
	...
	**恰恰是从第x层开始扔, 选择更高或是更低的一层都不合适**
	...
	![http://www.milky.show/images/algorithm/dynamic/dynamic_21.png](http://www.milky.show/images/algorithm/dynamic/dynamic_21.png)
...
* **方法四: 动态规划**
	...
	1. 利用状态转移方程式自底向上求解问题
		...
		![http://www.milky.show/images/algorithm/dynamic/dynamic_22.png](http://www.milky.show/images/algorithm/dynamic/dynamic_22.png)
...
​	![http://www.milky.show/images/algorithm/dynamic/dynamic_23.png](http://www.milky.show/images/algorithm/dynamic/dynamic_23.png)
...
​	![http://www.milky.show/images/algorithm/dynamic/dynamic_24.png](http://www.milky.show/images/algorithm/dynamic/dynamic_24.png)
...
​	![http://www.milky.show/images/algorithm/dynamic/dynamic_25.png](http://www.milky.show/images/algorithm/dynamic/dynamic_25.png)

​	依照上面的方式, 我们计算出2个鸡蛋4层楼的最优尝试次数, 结果是3次。

​	![http://www.milky.show/images/algorithm/dynamic/dynamic_26.png](http://www.milky.show/images/algorithm/dynamic/dynamic_26.png)

​	同理, 我们按照上面的方式, 计算出3个鸡蛋在各个楼层的尝试次数, 分别是2次, 2次, 3次。具体计算过程就不再细说。

​	![http://www.milky.show/images/algorithm/dynamic/dynamic_27.png](http://www.milky.show/images/algorithm/dynamic/dynamic_27.png)
​	
...
​	![http://www.milky.show/images/algorithm/dynamic/dynamic_28.png](http://www.milky.show/images/algorithm/dynamic/dynamic_28.png)
