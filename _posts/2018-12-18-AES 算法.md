...
* 假设有一个发送方在向接收方发送消息。如果没有任何加密算法，接收方发送的是一个明文消息：“我是小灰”
	...
	![http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_1.png](http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_1.png)

	如果消息被中间人截获到，即使中间人无法篡改消息，也可以窥探到消息的内容，从而暴露了通信双方的私密。

	因此我们不再直接传送明文，而改用对称加密的方式传输密文，画风就变成了下面这样：

	![http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_2.png](http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_2.png)
...
* 要想了解填充的概念，我们先要了解AES的**分组加密**特性。
	...
	![http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_3.png](http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_3.png)
...
* 下面来看一张图, 揭示出AES加密器的神秘面纱
	...
	![http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_4.png](http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_4.png)
	...
	* 字节代替（SubBytes）
		...
		![http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_5.png](http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_5.png)
	...
	* 行移位（ShiftRows）
		...
		![http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_6.png](http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_6.png)
	...
	* 列混淆（MixColumns）
		...
		![http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_7.png](http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_7.png)

		这一步，输入数组的每一列要和一个名为修补矩阵（fixed matrix）的二维常量数组做矩阵相乘，得到对应的输出列。

	* 加轮密钥（AddRoundKey）

		![http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_8.png](http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_8.png)
...
* ECB模式（Electronic Codebook Book）是最简单的工作模式，在该模式下，每一个明文块的加密都是完全独立，互不干涉的。
	...
	![http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_9.png](http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_9.png)
...
* CBC模式（Cipher Block Chaining）引入了一个新的概念：初始向量IV（Initialization Vector）。
	...
	![http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_10.png](http://www.miaomiaoqi.github.io/images/algorithm/aes/aes_10.png)
