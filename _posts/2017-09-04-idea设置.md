...
* codehelper.generator
    ...
    1. GenDaoCode
    	...
    	在 pojo 中使用该功能自动生成 service, dao, sql, xml文件

    在 KeyMap 中配置 CodeHelper 快捷键
...
* RestfulToolkit
    ...
    1. 方便我们根据 url 搜寻 controller, 在 KeyMap 中配置 RestfulToolkit 下的 Service 快捷键使用
