...
* 由于网络或服务端不可靠，会导致调用出现一种不确定的中间状态（超时）。为了避免超时导致客户端资源（线程）挂起耗尽，必须设置超时时间。
    ...
    * 配置原则
        ...
        ![http://www.milky.show/images/dubbo/1.png](http://www.milky.show/images/dubbo/1.png)
...
![http://www.milky.show/images/dubbo/2.png](http://www.milky.show/images/dubbo/2.png)
...
* BIO：(Blocking IO)
	...
	![http://www.milky.show/images/dubbo/3.png](http://www.milky.show/images/dubbo/3.png)

* NIO (Non-Blocking IO)

	![http://www.milky.show/images/dubbo/4.png](http://www.milky.show/images/dubbo/4.png)
...
* Netty基本原理
	...
	![http://www.milky.show/images/dubbo/5.png](http://www.milky.show/images/dubbo/5.png)

### Dubbo设计架构

![http://www.milky.show/images/dubbo/6.png](http://www.milky.show/images/dubbo/6.png)
...
![http://www.milky.show/images/dubbo/7.png](http://www.milky.show/images/dubbo/7.png)

### 服务引用流程

![http://www.milky.show/images/dubbo/8.png](http://www.milky.show/images/dubbo/8.png)
