...
* 在内存中维护数据集合, 按照顺序进行有序排序, 这一列表是线性的, 最容易表达线性结构的自然是数组和链表。可是，无论是数组还是链表，在插入新数据的时候，都会存在性能问题。
    ...
    * 如果使用数组，插入新商品的方式如下：
        ...
        ![http://www.miaomiaoqi.cn/images/algorithm/jump/jump_1.png](http://www.miaomiaoqi.cn/images/algorithm/jump/jump_1.png)
    ...
    * 如果使用链表，插入新商品的方式如下：
        ...
        ![http://www.miaomiaoqi.cn/images/algorithm/jump/jump_2.png](http://www.miaomiaoqi.cn/images/algorithm/jump/jump_2.png)
...
* 跳跃表(skiplist)是一种基于有序链表的扩展, 简称跳表
    ...
    ![http://www.miaomiaoqi.cn/images/algorithm/jump/jump_3.png](http://www.miaomiaoqi.cn/images/algorithm/jump/jump_3.png)

    此时如果要插入一个值是4的新节点, 不再需要和原节点的8,7,6,5,3逐一比较, 只需要比较关键节点7,5,3

    ![http://www.miaomiaoqi.cn/images/algorithm/jump/jump_4.png](http://www.miaomiaoqi.cn/images/algorithm/jump/jump_4.png)

    确定了新节点在关键节点中的位置(3和5之间), 就可以回到原链表, 迅速定位到对应的位置插入(恰巧同样是3和5)

    ![http://www.miaomiaoqi.cn/images/algorithm/jump/jump_5.png](http://www.miaomiaoqi.cn/images/algorithm/jump/jump_5.png)

    我们可以进一步思考, 既然已经提取出了一层关键节点作为索引, 那我们为何不能从索引中进一步提取, 提出一层索引的索引

    ![http://www.miaomiaoqi.cn/images/algorithm/jump/jump_6.png](http://www.miaomiaoqi.cn/images/algorithm/jump/jump_6.png)
...
这时候需要从新节点中选取一部分提到上一层, 可究竟应该提拔谁忽略谁呢?关于这一点, 跳跃表的设计者采用了一种有趣的办法**[抛硬币]**, 也就是随机决定新节点是否提拔, 每向上提拔一层的几率是50%
    ...
    ![http://www.miaomiaoqi.cn/images/algorithm/jump/jump_7.png](http://www.miaomiaoqi.cn/images/algorithm/jump/jump_7.png)

    ![http://www.miaomiaoqi.cn/images/algorithm/jump/jump_8.png](http://www.miaomiaoqi.cn/images/algorithm/jump/jump_8.png)

    ![http://www.miaomiaoqi.cn/images/algorithm/jump/jump_9.png](http://www.miaomiaoqi.cn/images/algorithm/jump/jump_9.png)
    ...
    **总体上，跳跃表插入操作的时间复杂度是O（logN），而这种数据结构所占空间是2N，既空间复杂度是 O（N）。**
    ...
    ![http://www.miaomiaoqi.cn/images/algorithm/jump/jump_10.png](http://www.miaomiaoqi.cn/images/algorithm/jump/jump_10.png)
