...
<img src="http://www.milky.show/images/algorithm/jump/jump_12.png" alt="http://www.milky.show/images/algorithm/jump/jump_12.png" style="zoom: 50%;" />

新结点在成功晋升之后，仍然有机会继续向上一层索引晋升。我们再进行一次随机，假设随机的结果是晋升失败，那么插入操作就告一段落了。

让我们看看下图，新结点10已经晋升到第2层索引，下一次随机的结果仍然是晋升成功，这时候该怎么办呢？

<img src="http://www.milky.show/images/algorithm/jump/jump_13.png" alt="http://www.milky.show/images/algorithm/jump/jump_13.png" style="zoom: 50%;" />

这时候我们直接让索引增加一层, 就像下面这样

<img src="http://www.milky.show/images/algorithm/jump/jump_14.png" alt="http://www.milky.show/images/algorithm/jump/jump_14.png" style="zoom: 50%;" />

## 删除

假设我们要从跳表中删除结点10，首先我们按照跳表查找结点的方法，找到待删除的结点：

<img src="http://www.milky.show/images/algorithm/jump/jump_15.png" alt="http://www.milky.show/images/algorithm/jump/jump_15.png" style="zoom: 50%;" />

接下来，按照一般链表的删除方式，把结点10从原始链表当中删除：

<img src="http://www.milky.show/images/algorithm/jump/jump_16.png" alt="http://www.milky.show/images/algorithm/jump/jump_16.png" style="zoom: 50%;" />

这样是不是删除工作就完成了呢？并不是。我们需要顺藤摸瓜，把索引当中的对应结点也一一删除：

<img src="http://www.milky.show/images/algorithm/jump/jump_17.png" alt="http://www.milky.show/images/algorithm/jump/jump_17.png" style="zoom: 50%;" />

刚才的例子当中，第3层索引的结点已经没有了，因此我们把整个第3层删去：

<img src="http://www.milky.show/images/algorithm/jump/jump_18.png" alt="http://www.milky.show/images/algorithm/jump/jump_18.png" style="zoom: 50%;" />

最终的删除结果如下：

<img src="http://www.milky.show/images/algorithm/jump/jump_19.png" alt="http://www.milky.show/images/algorithm/jump/jump_19.png" style="zoom: 50%;" />
...
<img src="http://www.milky.show/images/algorithm/jump/jump_20.png" alt="http://www.milky.show/images/algorithm/jump/jump_20.png" style="zoom: 50%;" />
