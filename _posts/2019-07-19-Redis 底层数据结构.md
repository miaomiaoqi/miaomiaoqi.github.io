...
![https://miaomiaoqi.github.io/images/redis/redisobject.png](https://miaomiaoqi.github.io/images/redis/redisobject.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_5.png](https://miaomiaoqi.github.io/images/redis/redis_5.png)
...
2. **杜绝缓冲区溢出**
    ...
    ![https://miaomiaoqi.github.io/images/redis/redis_19.png](https://miaomiaoqi.github.io/images/redis/redis_19.png)
    ...
    ![https://miaomiaoqi.github.io/images/redis/redis_20.png](https://miaomiaoqi.github.io/images/redis/redis_20.png)
    ...
    ![https://miaomiaoqi.github.io/images/redis/redis_17.png](https://miaomiaoqi.github.io/images/redis/redis_17.png)

    ![https://miaomiaoqi.github.io/images/redis/redis_18.png](https://miaomiaoqi.github.io/images/redis/redis_18.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_21.png](https://miaomiaoqi.github.io/images/redis/redis_21.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_22.png](https://miaomiaoqi.github.io/images/redis/redis_22.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_6.png](https://miaomiaoqi.github.io/images/redis/redis_6.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_23.png](https://miaomiaoqi.github.io/images/redis/redis_23.png)
...
![https://miaomiaoqi.github.io/images/redis_24.png](https://miaomiaoqi.github.io/images/redis_24.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_25.png](https://miaomiaoqi.github.io/images/redis/redis_25.png)
...
1. 执行 rehash 之前的字典
    ...
    ![https://miaomiaoqi.github.io/images/redis/redis_32.png](https://miaomiaoqi.github.io/images/redis/redis_32.png)

2. 为字典的 ht[1] 哈希表分配空间

    ![https://miaomiaoqi.github.io/images/redis/redis_33.png](https://miaomiaoqi.github.io/images/redis/redis_33.png)

3. ht[0] 的所有键值对都已经被迁移到 ht[1]

    ![https://miaomiaoqi.github.io/images/redis/redis_34.png](https://miaomiaoqi.github.io/images/redis/redis_34.png)

4. 完成 rehash 之后的字典

    ![https://miaomiaoqi.github.io/images/redis/redis_35.png](https://miaomiaoqi.github.io/images/redis/redis_35.png)
...
1. 准备开始rehash
    ...
    ![https://miaomiaoqi.github.io/images/redis/redis_26.png](https://miaomiaoqi.github.io/images/redis/redis_26.png)

2. rehash 索引 0 上的键值对

    ![https://miaomiaoqi.github.io/images/redis/redis_27.png](https://miaomiaoqi.github.io/images/redis/redis_27.png)

3. rehash 索引 1 上的键值对

    ![https://miaomiaoqi.github.io/images/redis/redis_28.png](https://miaomiaoqi.github.io/images/redis/redis_28.png)

4. rehash 索引 2 上的键值对

    ![https://miaomiaoqi.github.io/images/redis/redis_29.png](https://miaomiaoqi.github.io/images/redis/redis_29.png)

5. rehash 索引 3 上的键值对

    ![https://miaomiaoqi.github.io/images/redis/redis_30.png](https://miaomiaoqi.github.io/images/redis/redis_30.png)

6. rehash 完毕

    ![https://miaomiaoqi.github.io/images/redis/redis_31.png](https://miaomiaoqi.github.io/images/redis/redis_31.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_8.png](https://miaomiaoqi.github.io/images/redis/redis_8.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_36.png](https://miaomiaoqi.github.io/images/redis/redis_36.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_37.png](https://miaomiaoqi.github.io/images/redis/redis_37.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_38.png](https://miaomiaoqi.github.io/images/redis/redis_38.png)

再举个例子，  用虚线标记了在跳跃表中查找分值为 2.0 、 成员对象为 o2 的节点时， 沿途经历的层： 在查找节点的过程中， 程序经过了两个跨度为 1 的节点， 因此可以计算出， 目标节点在跳跃表中的排位为 2 。

![https://miaomiaoqi.github.io/images/redis/redis_39.png](https://miaomiaoqi.github.io/images/redis/redis_39.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_40.png](https://miaomiaoqi.github.io/images/redis/redis_40.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_41.png](https://miaomiaoqi.github.io/images/redis/redis_41.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_7.png](https://miaomiaoqi.github.io/images/redis/redis_7.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_42.png](https://miaomiaoqi.github.io/images/redis/redis_42.png)	
...
![https://miaomiaoqi.github.io/images/redis/redis_43.png](https://miaomiaoqi.github.io/images/redis/redis_43.png)	
...
![https://miaomiaoqi.github.io/images/redis/redis_44.png](https://miaomiaoqi.github.io/images/redis/redis_44.png)	

因为每个元素都占用 16 位空间， 所以整数集合底层数组的大小为 3 * 16 = 48 位， 图 6-4 展示了整数集合的三个元素在这 48 位里的位置。

![https://miaomiaoqi.github.io/images/redis/redis_45.png](https://miaomiaoqi.github.io/images/redis/redis_45.png)	
...
![https://miaomiaoqi.github.io/images/redis/redis_46.png](https://miaomiaoqi.github.io/images/redis/redis_46.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_47.png](https://miaomiaoqi.github.io/images/redis/redis_47.png)

接着， 因为元素 2 在 1 、 2 、 3 、 65535 四个元素中排名第二， 所以它将被移动到 contents 数组的索引 1 位置上， 也即是数组的 32 位至 63 位的空间内， 如图 6-7 所示。

![https://miaomiaoqi.github.io/images/redis/redis_48.png](https://miaomiaoqi.github.io/images/redis/redis_48.png)

之后， 因为元素 1 在 1 、 2 、 3 、 65535 四个元素中排名第一， 所以它将被移动到 contents 数组的索引 0 位置上， 也即是数组的 0 位至 31 位的空间内， 如图 6-8 所示。

![https://miaomiaoqi.github.io/images/redis/redis_49.png](https://miaomiaoqi.github.io/images/redis/redis_49.png)

然后， 因为元素 65535 在 1 、 2 、 3 、 65535 四个元素中排名第四， 所以它将被添加到 contents 数组的索引 3 位置上， 也即是数组的 96 位至 127 位的空间内， 如图 6-9 所示。

![https://miaomiaoqi.github.io/images/redis/redis_50.png](https://miaomiaoqi.github.io/images/redis/redis_50.png)

最后， 程序将整数集合 encoding 属性的值从 INTSET_ENC_INT16 改为 INTSET_ENC_INT32 ， 并将 length 属性的值从 3 改为 4 ， 设置完成之后的整数集合如图 6-10 所示。

![https://miaomiaoqi.github.io/images/redis/redis_51.png](https://miaomiaoqi.github.io/images/redis/redis_51.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_9.png](https://miaomiaoqi.github.io/images/redis/redis_9.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_52.png](https://miaomiaoqi.github.io/images/redis/redis_52.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_53.png](https://miaomiaoqi.github.io/images/redis/redis_53.png)



**压缩列表的每个节点构成如下：**

![https://miaomiaoqi.github.io/images/redis/redis_10.png](https://miaomiaoqi.github.io/images/redis/redis_10.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_54.png](https://miaomiaoqi.github.io/images/redis/redis_54.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_55.png](https://miaomiaoqi.github.io/images/redis/redis_55.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_56.png](https://miaomiaoqi.github.io/images/redis/redis_56.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_57.png](https://miaomiaoqi.github.io/images/redis/redis_57.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_11.png](https://miaomiaoqi.github.io/images/redis/redis_11.png)

**embstr 编码的字符串对象:**

![https://miaomiaoqi.github.io/images/redis/redis_12.png](https://miaomiaoqi.github.io/images/redis/redis_12.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_13.png](https://miaomiaoqi.github.io/images/redis/redis_13.png)

linkedlist是一种双向链表。它的结构比较简单，节点中存放pre和next两个指针，还有节点相关的信息。当每增加一个node的时候，就需要重新malloc一块内存。

![https://miaomiaoqi.github.io/images/redis/redis_14.png](https://miaomiaoqi.github.io/images/redis/redis_14.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_15.png](https://miaomiaoqi.github.io/images/redis/redis_15.png)
...
![https://miaomiaoqi.github.io/images/redis/redis_16.png](https://miaomiaoqi.github.io/images/redis/redis_16.png)
