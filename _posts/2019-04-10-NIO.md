...
![http://www.milky.show/images/java/nio/nio_1.png](http://www.milky.show/images/java/nio/nio_1.png)

一个 Selector 可以有多个 Channel, **可以只用一个线程来维护 Selector 监听客户端消息, 避免了多线程的消耗.**

![http://www.milky.show/images/java/nio/nio_2.png](http://www.milky.show/images/java/nio/nio_2.png)

![http://www.milky.show/images/java/nio/nio_3.png](http://www.milky.show/images/java/nio/nio_3.png)

![http://www.milky.show/images/java/nio/nio_4.png](http://www.milky.show/images/java/nio/nio_4.png)

![http://www.milky.show/images/java/nio/nio_5.png](http://www.milky.show/images/java/nio/nio_5.png)

![http://www.milky.show/images/java/nio/nio_6.png](http://www.milky.show/images/java/nio/nio_6.png)
