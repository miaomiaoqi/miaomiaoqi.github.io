...
## 常用快捷键
    ...
    command + n: 在文件结构上使用，可新建类等。在代码编辑窗口使用，可自动生成getter、setter方法，构造器，重写方法。(New Folder.../Generate...)
...
​    
    ...
    shift + h: 查看方法结构(Method Hierarchy)
...
* AceJump
    ...
    ctrl + ;激活插件, 输入想要跳转的字符, 输入快捷跳转对应的字符
