...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_1.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_1.png)

最容易想到的显然是用 AOP

![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_2.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_2.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_3.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_3.png)

如图示:一个稍微复杂的微服务架构

如果有用户反馈某个页面很慢, 我们知道这个页面的请求调用链是 A ----->  C ----->  B ----->  D, 此时如何定位可能是哪个模块引起的问题. 每个服务 Service A,B,C,D 都有好几台机器. 怎么知道某个请求调用了服务的具体哪台机器呢? 

![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_4.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_4.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_5.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_5.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_6.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_6.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_7.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_7.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_8.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_8.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_9.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_9.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_10.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_10.png)

根据这些图表信息显然可以据此来画出调用链的可视化视图如下

![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_11.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_11.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_12.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_12.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_13.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_13.png)

dubbo 中的 attachment 就相当于 header, 所以我们把 context 放在 attachment 中, 这样就解决了 context 的传递问题. 

![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_14.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_14.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_15.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_15.png)

**图示: snowflake 算法生成的 id**

不过 snowflake 算法有一个众所周知的问题:**时间回拨**, 这个问题可能会导致生成的 id 重复. 那么 SkyWalking 是如何解决时间回拨问题的呢. 

![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_16.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_16.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_17.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_17.png)

这样的采样频率其实足够我们分析组件的性能了, 按 3 秒采样 3 次这样的频率来采样数据会有啥问题呢. 理想情况下, 每个服务调用都在同一个时间点（如下图示）这样的话每次都在同一时间点采样确实没问题

![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_18.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_18.png)

但在生产上, 每次服务调用基本不可能都在同一时间点调用, 因为期间有网络调用延时等, 实际调用情况很可能是下图这样

![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_19.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_19.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_20.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_20.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_21.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_21.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_22.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_22.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_23.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_23.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_24.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_24.png)

#### 实现更细粒度的采样?

哈叫更细粒度的采样. 先来看下 skywalking 默认的采样方式,  即统一采样

![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_25.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_25.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_26.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_26.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_27.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_27.png)

然后我们再实现一个 log4j 的插件, 如下

![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_28.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_28.png)
...
![http://www.miaomiaoqi.github.io/images/distributed/trace/trace_29.png](http://www.miaomiaoqi.github.io/images/distributed/trace/trace_29.png)
