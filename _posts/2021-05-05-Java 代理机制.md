...
![http://www.milky.show/images/proxy/proxy_1.png](http://www.milky.show/images/proxy/proxy_1.png)
...
![http://www.milky.show/images/proxy/proxy_2.png](http://www.milky.show/images/proxy/proxy_2.png)
...
![http://www.milky.show/images/proxy/proxy_3.png](http://www.milky.show/images/proxy/proxy_3.png)
...
![http://www.milky.show/images/proxy/proxy_4.png](http://www.milky.show/images/proxy/proxy_4.png)
...
![http://www.milky.show/images/proxy/proxy_5.png](http://www.milky.show/images/proxy/proxy_5.png)
...
![http://www.milky.show/images/proxy/proxy_6.png](http://www.milky.show/images/proxy/proxy_6.png)
...
![http://www.milky.show/images/proxy/proxy_7.png](http://www.milky.show/images/proxy/proxy_7.png)
...
![http://www.milky.show/images/proxy/proxy_8.png](http://www.milky.show/images/proxy/proxy_8.png)
...
3. 创建一个处理类并实现 `InvocationHandler` 接口, 重写其 `invoke` 方法(在`invoke` 方法中利用反射机制调用委托类的方法, 并自定义一些处理逻辑), 并将委托类注入处理类
    ...
    ![http://www.milky.show/images/proxy/proxy_9.png](http://www.milky.show/images/proxy/proxy_9.png)
    ...
    * method: 还记得我们在上篇文章反射中讲到的 `Method.invoke` 吗？就是这个, 我们可以通过它来调用委托类的方法(反射)
        ...
        ![http://www.milky.show/images/proxy/proxy_10.png](http://www.milky.show/images/proxy/proxy_10.png)

    * args: 传给委托类方法的参数列表

4. 创建代理对象(Proxy): 通过 `Proxy.newProxyInstance()` 创建委托类对象的代理对象

    ![http://www.milky.show/images/proxy/proxy_11.png](http://www.milky.show/images/proxy/proxy_11.png)
...
![http://www.milky.show/images/proxy/proxy_12.png](http://www.milky.show/images/proxy/proxy_12.png)
...
2. 创建一个方法拦截器实现接口 `MethodInterceptor`, 并重写 `intercept` 方法. `intercept` 用于拦截并增强委托类的方法(和 JDK 动态代理 `InvocationHandler`中的 `invoke` 方法类似)
    ...
    ![http://www.milky.show/images/proxy/proxy_13.png](http://www.milky.show/images/proxy/proxy_13.png)
    ...
    - MethodProxy var4: 用于调用委托类的原始方法(底层也是通过反射机制, 不过不是 `Method.invoke` 了, 而是使用 `MethodProxy.invokeSuper` 方法)
        ...
        ![http://www.milky.show/images/proxy/proxy_14.png](http://www.milky.show/images/proxy/proxy_14.png)

3. 创建代理对象(Proxy): 通过 `Enhancer.create()` 创建委托类对象的代理对象

    ![http://www.milky.show/images/proxy/proxy_15.png](http://www.milky.show/images/proxy/proxy_15.png)
