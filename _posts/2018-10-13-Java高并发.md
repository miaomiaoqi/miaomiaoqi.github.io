...
* CPU多级缓存
    ...
    * 缓存一致性(MESI)
        ...
        ![http://www.milky.show/images/concurrency/1.png](http://www.milky.show/images/concurrency/1.png)
...
* Java内存模型(Java Memory Model, JMM)
    ...
    ![http://www.milky.show/images/concurrency/1.png](http://www.milky.show/images/concurrency/2.png)
    ...
    * 同步规则
        ...
        ![http://www.milky.show/images/concurrency/1.png](http://www.milky.show/images/concurrency/3.png)
        
        ![http://www.milky.show/images/concurrency/1.png](http://www.milky.show/images/concurrency/4.png)
...
* 当多个线程访问某个类时, 不管运行时环境采用何种调度方式或者这些进程将如何交替执行, 并且在主调代码中不需要任何额外的同步或协同, 这个类都能表现出正确的行为, 那么就称这个类是线程安全的
    ...
    * 可见性
        ...
        * 对volatile变量写操作时, 会在写操作后加入一条store屏障指令, 将本地内存中的共享变量值刷新到主存中
            ...
            ![http://www.milky.show/images/concurrency/5.png](http://www.milky.show/images/concurrency/5.png)

        * 对volatile变量读操作时, 会在读操作前加入一条load屏障指令, 从主内存中读取共享变量

            ![http://www.milky.show/images/concurrency/6.png](http://www.milky.show/images/concurrency/6.png)
...
* AQS同步组件
    ...
    * CountDownLatch
        ...
        ![http://www.milky.show/images/concurrency/7.png](http://www.milky.show/images/concurrency/7.png)
...
* ThreadPoolExecutor
    ...
    * 核心参数
    ...
    ![http://www.milky.show/images/concurrency/8.png](http://www.milky.show/images/concurrency/8.png)
    ...
    * 核心方法
    ...
    ![http://www.milky.show/images/concurrency/9.png](http://www.milky.show/images/concurrency/9.png)
...
![http://www.milky.show/images/concurrency/10.png](http://www.milky.show/images/concurrency/10.png)
...
![http://www.milky.show/images/concurrency/11.png](http://www.milky.show/images/concurrency/11.png)
...
![http://www.milky.show/images/concurrency/12.png](http://www.milky.show/images/concurrency/12.png)
...
![http://www.milky.show/images/concurrency/13.png](http://www.milky.show/images/concurrency/13.png)
