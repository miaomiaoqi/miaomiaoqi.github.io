...
![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_1.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_1.png)
...
![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_2.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_2.png)

**但是，因为HashMap的长度是有限的，当插入的Entry越来越多时，再完美的Hash函数也难免会出现 index 冲突的情况。比如下面这样：**

![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_3.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_3.png)

这时候该怎么办呢？我们可以利用**链表**来解决。

HashMap数组的每一个元素不止是一个Entry对象，也是一个链表的头节点。每一个Entry对象通过Next指针指向它的下一个Entry节点。当新来的Entry映射到冲突的数组位置时，只需要插入到对应的链表即可：

![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_4.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_4.png)
...
![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_5.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_5.png)
...
![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_6.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_6.png)

**Resize 后的 HashMap:**

![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_7.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_7.png)
...
![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_8.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_8.png)

![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_9.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_9.png)

此时达到 Resize 条件，两个线程各自进行 Rezie 的第一步，也就是扩容：

![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_10.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_10.png)

这时候，两个线程都走到了 ReHash 的步骤。让我们回顾一下 ReHash 的代码：

![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_11.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_11.png)
...
![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_12.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_12.png)
...
![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_13.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_13.png)

当执行到上面这一行时，显然 i = 3，因为刚才线程 A 对于 Entry3 的 hash 结果也是 3。

![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_14.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_14.png)
...
![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_15.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_15.png)

接着是新一轮循环，又执行到红框内的代码行：

![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_16.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_16.png)
...
![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_17.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_17.png)

接下来执行下面的三行，用头插法把 Entry2 插入到了线程B的数组的头结点：

![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_18.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_18.png)

整体情况如图所示：

![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_19.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_19.png)

第三次循环开始，又执行到红框的代码：

![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_20.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_20.png)
...
![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_21.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_21.png)
...
![https://miaomiaoqi.github.io/images/java/hashmap/hashmap_22.png](https://miaomiaoqi.github.io/images/java/hashmap/hashmap_22.png)
...
![https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_1.png](https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_1.png)

**像这样的 Segment 对象，在 ConcurrentHashMap 集合中有多少个呢？有 2 的 N 次方个，共同保存在一个名为 segments的数组当中。**

因此整个ConcurrentHashMap的结构如下：

![https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_2.png](https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_2.png)
...
![https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_3.png](https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_3.png)

不同Segment的写入是可以并发执行的。

**Case2：同一Segment的一写一读**

![https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_4.png](https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_4.png)

**Case3：同一Segment的并发写入**

![https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_5.png](https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_5.png)
...
![https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_6.png](https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_6.png)

![https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_7.png](https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_7.png)

![https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_8.png](https://miaomiaoqi.github.io/images/java/concurrenthashmap/ch_8.png)
