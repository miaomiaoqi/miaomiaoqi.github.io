...
![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_1.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_1.png)
...
![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_2.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_2.png)
...
![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_3.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_3.png)
...
![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_4.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_4.png)
...
![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_5.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_5.png)
...
<img src="http://www.miaomiaoqi.github.io/images/database/mysql/mysql_4.png" alt="http://www.miaomiaoqi.github.io/images/database/mysql/mysql_4.png" style="zoom: 50%;" />

如图所示, InnoDB每行数据除了用户定义的数据外, 还包括TRX_ID(当前数据属于哪个事务ID)、ROLL_PTR(指向这一行数据undo log的指针)、delete bit(删除标记). 

<img src="http://www.miaomiaoqi.github.io/images/database/mysql/mysql_5.png" alt="http://www.miaomiaoqi.github.io/images/database/mysql/mysql_5.png" style="zoom: 33%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/database/mysql/mysql_6.png" alt="http://www.miaomiaoqi.github.io/images/database/mysql/mysql_6.png" style="zoom: 33%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/database/mysql/mysql_3.png" alt="http://www.miaomiaoqi.github.io/images/database/mysql/mysql_3.png" style="zoom: 33%;" />
...
1.  A 修改事务级别为: 未提交读.并开始事务, 对 user 表做一次查询
    ...
    ![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_9.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_9.png)

2.  B 事务更新一条记录

    ![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_10.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_10.png)

3.  此时 B 事务还未提交, A在事务内做一次查询, 发现查询结果已经改变

    ![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_11.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_11.png)

4.  B 进行事务回滚

    ![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_12.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_12.png)

5.  A 再做一次查询, 查询结果又变回去了

    ![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_13.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_13.png)
...
1.  把隔离性调为READ-COMMITTED(读取提交内容)设置A的事务隔离级别, 并进入事务做一次查询
    ...
    <img src="http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_14.png" alt="http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_14.png" style="zoom:67%;" />

2.  B开始事务, 并对记录进行修改

    ![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_15.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_15.png)

3.  A再对user表进行查询, 发现记录没有受到影响

    ![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_16.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_16.png)

4.  B提交事务

    ![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_17.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_17.png)

5.  A再对user表查询, 发现记录被修改

    ![http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_18.png](http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_18.png)
...
<img src="http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_6.png" alt="http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_6.png" style="zoom:67%;" />

**垂直分表**

如果表字段比较多, 将不常用的、数据较大的等等做拆分

<img src="http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_7.png" alt="http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_7.png" style="zoom:50%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_8.png" alt="http://www.miaomiaoqi.github.io/images/database/mysql/lianhuan_8.png" style="zoom: 50%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/mysql/datafull/f_1.png" alt="http://www.miaomiaoqi.github.io/images/mysql/datafull/f_1.png" style="zoom:50%;" />
...
![http://www.miaomiaoqi.github.io/images/mysql/datafull/f_2.png](http://www.miaomiaoqi.github.io/images/mysql/datafull/f_2.png)
...
<img src="http://www.miaomiaoqi.github.io/images/mysql/datafull/f_3.png" alt="http://www.miaomiaoqi.github.io/images/mysql/datafull/f_3.png" style="zoom:50%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/mysql/datafull/f_4.png" alt="http://www.miaomiaoqi.github.io/images/mysql/datafull/f_4.png" style="zoom:50%;" />



然后对备份数据库进行还原, 点击还原

<img src="http://www.miaomiaoqi.github.io/images/mysql/datafull/f_5.png" alt="http://www.miaomiaoqi.github.io/images/mysql/datafull/f_5.png" style="zoom:67%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_1.png" alt="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_1.png" style="zoom:50%;" />

<img src="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_2.png" alt="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_2.png" style="zoom:50%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_3.png" alt="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_3.png" style="zoom:50%;" />

<img src="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_4.png" alt="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_4.png" style="zoom:50%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_5.png" alt="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_5.png" style="zoom:50%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_6.png" alt="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_6.png" style="zoom: 50%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_7.png" alt="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_7.png" style="zoom: 50%;" />
...
<img src="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_8.png" alt="http://www.miaomiaoqi.github.io/images/mysql/cpu/cpu_8.png" style="zoom: 50%;" />
