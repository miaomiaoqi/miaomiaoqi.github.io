...
*   id不同: 如果是子查询, id的序号会递增, id值越大优先级越高, 越先被执行
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_38.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_38.png)
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_39.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_39.png)
...
*   id为NULL: 最后执行
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_40.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_40.png)
...
*   SIMPLE: 简单查询. 查询中不包含子查询或者UNION. 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_41.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_41.png)
...
*   SUBQUERY: 子查询. 在SELECT或WHERE列表中包含了子查询. 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_42.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_42.png)
...
*   DEPENDENT SUBQUREY: 如果包含了子查询, 并且查询语句不能被优化器转换为连接查询, 并且子查询是相关子查询(子查询基于外部数据列) , 则子查询就是DEPENDENT SUBQUREY. 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_43.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_43.png)
...
*   UNCACHEABLE SUBQUREY: 表示这个subquery的查询要受到外部系统变量的影响
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_44.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_44.png)
...
*   UNION RESULT: UNION会对查询结果进行查询去重, MYSQL会使用临时表来完成UNION查询的去重工作, 针对这个临时表的查询就是"UNION RESULT". 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_45.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_45.png)

*   DEPENDENT UNION: 子查询中的UNION或者UNION ALL, 除了最左边的查询是DEPENDENTSUBQUREY, 其余的查询都是DEPENDENT UNION. 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_46.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_46.png)
...
*   DERIVED: 在包含派生表(子查询在from子句中) 的查询中, MySQL会递归执行这些子查询, 把结果放在临时表里. 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_47.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_47.png)
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_48.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_48.png)
...
*   MATERIALIZED: 优化器对于包含子查询的语句, 如果选择将子查询物化后再与外层查询连接查询, 该子查询的类型就是MATERIALIZED. 如下的例子中, 查询优化器先将子查询转换成物化表, 然后将t1和物化表进行连接查询. 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_49.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_49.png)
...
*   ALL: 全表扫描. Full Table Scan, 将遍历全表以找到匹配的行
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_50.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_50.png)
...
*   index: 当使用覆盖索引, 但需要扫描全部的索引记录时
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_51.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_51.png)
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_52.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_52.png)
...
*   range: 只检索给定范围的行, 使用一个索引来选择行. key 列显示使用了哪个索引, 一般就是在你的where语句中出现了between、<、>、in等的查询. 这种范围扫描索引扫描比全表扫描要好, 因为它只需要开始于索引的某一点, 而结束于另一点, 不用扫描全部索引. 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_53.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_53.png)
...
*   ref: 通过普通二级索引列与常量进行等值匹配时
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_54.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_54.png)
...
*   eq_ref: 连接查询时通过主键或不允许NULL值的唯一二级索引列进行等值匹配时
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_55.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_55.png)
...
*   const: 根据主键或者唯一二级索引列与常数进行匹配时
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_56.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_56.png)
...
*   system: MyISAM引擎中, 当表中只有一条记录时. (这是所有type的值中性能最高的场景)
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_57.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_57.png)
...
*   index_subquery: 利用普通索引来关联子查询, 针对包含有IN子查询的查询语句. content1是普通索引字段
    ...
    ```sql
    EXPLAIN SELECT * FROM t1 WHERE content IN (SELECT content1 FROM t4 WHERE
    t1.content = t4.content2) OR content = 'a';
    ```

    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_58.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_58.png)

*   unique_subquery: 类似于index_subquery, 利用唯一索引来关联子查询. t2的id是主键, 也可以理解为唯一的索引字段

    ```sql
    EXPLAIN SELECT * FROM t1 WHERE id IN (SELECT id FROM t2 WHERE t1.content =
    t2.content) OR content = 'a';
    ```

    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_59.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_59.png)
...
*   index_merge: 在查询过程中需要多个索引组合使用, 通常出现在有 or 的关键字的sql中. 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_60.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_60.png)
...
*   ref_or_null: 当对普通二级索引进行等值匹配, 且该索引列的值也可以是NULL值时
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_61.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_61.png)
...
* keys 表示实际使用的索引. 如果为NULL, 则没有使用索引. 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_62.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_62.png)
...
4.   允许为空的字段要加1个字节
     ...
     ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_63.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_63.png)
...
![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_64.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_64.png)
...
![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_65.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_65.png)
...
![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_66.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_66.png)
...
*   Impossible WHERE: where子句的值总是false
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_67.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_67.png)
...
*   Using where: 使用了where, 但在where上有字段没有创建索引
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_68.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_68.png)
...
*   Using temporary: 使了用临时表保存中间结果
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_69.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_69.png)
...
*   Using filesort: 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_70.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_70.png)
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_71.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_71.png)
...
*   Using index: 使用了覆盖索引, 表示直接访问索引就足够获取到所需要的数据, 不需要通过索引回表
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_72.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_72.png)

    ```sql
    EXPLAIN SELECT id FROM t1;
    ```

    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_73.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_73.png)
...
*   Using index condition: 叫作 Index Condition Pushdown Optimization (索引下推优化)
    ...
    *   如果使用了索引下推(ICP ), 那么MySQL在存储引擎层找到满足content1 > 'z' 条件的第一条二级索引记录. 不着急执行回表, 而是在这条记录上先判断一下所有关于idx_content1索引中包含的条件是否成立, 也就是content1 > 'z' AND content1 LIKE '%a' 是否成立. 如果这些条件不成立, 则直接跳过该二级索引记录, 去找下一条二级索引记录；如果这些条件成立, 则执行回表操作, 返回完整的记录给server层. 
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_74.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_74.png)

    注意: 如果这里的查询条件只有content1 > 'z' , 那么找到满足条件的索引后也会进行一次索引下推的操作, 判断content1 > 'z'是否成立(这是源码中为了编程方便做的冗余判断)

    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_75.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_75.png)
...
*   Using join buffer: 在连接查询时, 当被驱动表不能有效的利用索引时, MySQL会为其分配一块名为连接缓冲区(join buffer)的内存来加快查询速度
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_76.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_76.png)
    ...
    ![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_77.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_77.png)
...
![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_78.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_78.png)
...
![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_79.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_79.png)
...
![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_80.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_80.png)
...
![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_81.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_81.png)
...
![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_82.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_82.png)

![https://miaomiaoqi.github.io/images/database/mysql/interview/interview_83.png](https://miaomiaoqi.github.io/images/database/mysql/interview/interview_83.png)
...
*   Sending data
    ...
    正在处理Select查询的记录, 同时正在把结果发送给客户端. Sending data”状态的含义, 原来这个状态的名称很具有误导性, 所谓的“Sending data”并不是单纯的发送数据, 而是包括“收集 + 发送数据”. 
...
### 148 MySQL 服务器毫无规律的异常如何排查

首先查看 mysql 和系统日志进行排查

mysql 分为应用进程和守护进程

当应用进程占用过高的时候操作系统可能会 kill 掉进程, 此时守护进程又帮我们重启了应用进程, 运行一段时间后又出现 OOM 如此反复, 可以排查以下几个关键点
...
*   直接使用备份
*   配置 innodb_force_recover 跳过启动恢复过程
