...
Parker类里的_counter字段, 就是用来记录所谓的“**许可**”的, **当调用park时, 这个变量置为了0; 当调用unpark时, 这个变量置为 1**
...
考虑锁等线程安全问题的重任从"你"转移到了"队列"上. 我们不需要关心什么时候需要阻塞线程, 什么时候需要唤醒线程, 因为这一切 BlockingQueue 都帮你做了, 减少了程序员的负责度.
